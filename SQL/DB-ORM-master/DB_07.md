...
```python
Director.objects.values('name','debut','country')
```
...
```python
Director.objects.values('name','debut','country').get(id=1)
```
...
```python
Director.objects.values('name','debut','country').get(country='USA')
```
...
```python
Director.objects.get(name ='Joseph Kosinski').country ='USA'
Director.objects.values('name','debut','country').get(name ='Joseph Kosinski')
```
...
```python
Director.objects.values('name','debut','country').get(country = 'KOR')
```
...
```python
Director.objects.values('name','debut','country').filter(country = 'KOR')
```

### 13. 본인이 생각하는 혹은 찾은 `get` 과 `filter` 의 차이를 작성하세요.

```
get은 조건에 맞는 하나의 것만 반환하는데 filter는 조건에 맞는 그룹 데이터를 반환한다.
```
